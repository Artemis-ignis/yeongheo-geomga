...
export const ENEMIES = [
  ...
  },
  {
    ...
    behavior: 'splitter', color: 0xa3324a, scale: 1.2, splitInto: 2,
  },
  {
    id: 'demonCultivator', name: '마수사', hanja: '魔修士',
    hp: 160, speed: 3.4, damage: 22, radius: 0.85, kbResist: 0.5, xp: 15,
    behavior: 'dasher', color: 0x6b3fa0, scale: 1.4, elite: true, dashInterval: 4,
  },
]
