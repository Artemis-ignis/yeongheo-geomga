...
export const WAVES = [
  ...
  { t: 450, spawnInterval: 0.84, perSpawn: 7, types: ['wolf', 'stoneGhoul', 'demonCultivator', 'magmaBrute', 'glacierWarden'] },
  ...
  { t: 600, spawnInterval: 0.72, perSpawn: 9, types: ['wolf', 'stoneGhoul', 'bloodScorpion', 'demonCultivator', 'magmaBrute', 'glacierWarden'] },
  ...
  { t: 720, spawnInterval: 0.60, perSpawn: 11, types: ['wolf', 'stoneGhoul', 'talismanGhost', 'bloodScorpion', 'jadeSerpent', 'ashRaven', 'snowWraith'] },
  ...
  { t: 840, spawnInterval: 0.50, perSpawn: 15, types: ['wolf', 'stoneGhoul', 'talismanGhost', 'demonCultivator', 'magmaBrute', 'glacierWarden'] },
