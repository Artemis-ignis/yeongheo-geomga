...
// Generated from ObjectSculptSpec target: Void-Iron Cultivator v3
// Sculpt build pass: blockout
// This factory is intentionally pass-gated. Finish browser screenshot review before unlocking deeper passes.
export function createVoidIronCultivatorV3Model(options: ProceduralModelOptions = {}): THREE.Group {
  const root = new THREE.Group();
  root.name = "Void-Iron Cultivator v3";
  root.userData.reconstructionEvidence = {"itemFamily": null, "subtype": null, "componentAdapter": null, "route": null, "exactnessTier": null, "referenceCamera": {"solved": false, "fovDegrees": 40.0, "aspect": 1.0, "orientation": {"yaw": 0.0, "pitch": 0.0, "roll": 0.0}, "positionHint": [0.0, 0.0, 3.0], "note": "Generated turnaround is orthographic-like studio evidence; solve a review camera before final likeness lock."}, "approximationNotes": []};
  ...
  materialMap["base"] = createSculptMaterial(
    "base",
    {"id": "base", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#162132", "color": "#162132", "albedo": {"dominant": "#162132", "secondary": ["#383B3D", "#797A7A"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#162132", "#383B3D", "#797A7A"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.48, "variation": 0.18, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.84, "variation": 0.08}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.26, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "base", "sharedEvidenceMaterial": null}, "qualityTier": "hero"},
    options
  );
  materialMap["hidden"] = createSculptMaterial(
    "hidden",
    {"id": "hidden", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#11151E", "color": "#11151E", "albedo": {"dominant": "#11151E", "secondary": ["#2A3342"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#11151E", "#2A3342"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 1.0, "variation": 0.0, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.0, "variation": 0.0}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "opacity": {"base": 0.0}, "qualityTier": "utility", "referencePbr": {"materialId": "hidden", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  materialMap["skin"] = createSculptMaterial(
    "skin",
    {"id": "skin", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#5A6573", "color": "#5A6573", "albedo": {"dominant": "#5A6573", "secondary": ["#8A96A6", "#273241"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#5A6573", "#8A96A6", "#273241"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.56, "variation": 0.14, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.08, "variation": 0.03}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "qualityTier": "hero", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "skin", "sharedEvidenceMaterial": "base"}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  materialMap["hair"] = createSculptMaterial(
    "hair",
    {"id": "hair", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#0D0E10", "color": "#0D0E10", "albedo": {"dominant": "#0D0E10", "secondary": ["#343B4C", "#121B2A"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#0D0E10", "#343B4C", "#121B2A"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.62, "variation": 0.12, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.02, "variation": 0.02}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "qualityTier": "hero", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "hair", "sharedEvidenceMaterial": "base"}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  materialMap["shirt"] = createSculptMaterial(
    "shirt",
    {"id": "shirt", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#121B2A", "color": "#121B2A", "albedo": {"dominant": "#121B2A", "secondary": ["#243E50", "#0B111B"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#121B2A", "#243E50", "#0B111B"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.78, "variation": 0.12, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.03, "variation": 0.02}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "qualityTier": "hero", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "shirt", "sharedEvidenceMaterial": "base"}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  materialMap["pants"] = createSculptMaterial(
    "pants",
    {"id": "pants", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#101A29", "color": "#101A29", "albedo": {"dominant": "#101A29", "secondary": ["#243E50", "#0B111B"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#101A29", "#243E50", "#0B111B"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.8, "variation": 0.1, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.02, "variation": 0.02}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "qualityTier": "hero", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "pants", "sharedEvidenceMaterial": "base"}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  materialMap["shoes"] = createSculptMaterial(
    "shoes",
    {"id": "shoes", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#0D1119", "color": "#0D1119", "albedo": {"dominant": "#0D1119", "secondary": ["#303D4F", "#162132"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#0D1119", "#303D4F", "#162132"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.58, "variation": 0.16, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.32, "variation": 0.08}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "qualityTier": "hero", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "shoes", "sharedEvidenceMaterial": "base"}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  materialMap["eye"] = createSculptMaterial(
    "eye",
    {"id": "eye", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#52E5E7", "color": "#52E5E7", "albedo": {"dominant": "#52E5E7", "secondary": ["#B8FFFF", "#0B5669"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#52E5E7", "#B8FFFF", "#0B5669"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.22, "variation": 0.08, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.04, "variation": 0.04}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "qualityTier": "hero", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "eye", "sharedEvidenceMaterial": "base"}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  materialMap["lips"] = createSculptMaterial(
    "lips",
    {"id": "lips", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#5A6573", "color": "#5A6573", "albedo": {"dominant": "#5A6573", "secondary": ["#8A96A6"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#5A6573", "#8A96A6"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.58, "variation": 0.08, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.02, "variation": 0.02}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.18, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "qualityTier": "utility", "referencePbr": {"materialId": "lips", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "The four-view ImageGen turnaround does not provide trustworthy per-material masks; keep one canonical Forge extraction until isolated crops are authored."}},
    options
  );
  ...
  node_eye_l_13.userData.sculptComponent = {"id": "eye-l", "name": "Eye L", "level": "micro", "role": "detail", "importance": 0.5, "confidence": 0.8, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Eye L is a discrete primitive body part assembled onto the humanoid rig, not a continuous sculpt or shell.", "geometryDescriptor": {"topologyIntent": "stylized character part", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "smooth vertex normals"}, "parent": "head", "attachment": null, "dimensions": {"width": 0.030800000000000004, "height": 0.030800000000000004, "depth": 0.030800000000000004, "units": "relative", "confidence": 0.8}, "transform": {"position": [0.053200000000000004, 0.008400000000000001, 0.11200000000000002], "rotation": [0, 0, 0], "scale": [0.030800000000000004, 0.030800000000000004, 0.030800000000000004]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "box proxy"}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "eye-l", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "eye"}}, "material": "eye", "materialLayers": ["eye"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "eye-l-surface-breakup", "kind": "linework", "description": "Subject-specific armor/visor breakup derived from the ImageGen turnaround.", "evidenceRefs": ["front-three-quarter", "front"], "realization": "geometry-plus-material-response"}, {"id": "cyan-lens-glow", "kind": "emissive", "description": "Cyan glass lens uses a low-intensity bloom-safe emission response.", "evidenceRefs": ["front-three-quarter", "front"], "realization": "geometry-plus-material-response"}], "surfaceDetail": {"macroRoughness": 0.3, "microRoughness": 0.1, "bumpAmplitude": 0.018, "normalPattern": "reference-derived height plus authored panel grooves", "displacementPattern": "micro edge bevel only; no runtime displacement", "occlusionPattern": "contact darkening at plate overlaps and socket seams", "edgeWearPattern": "sparse pale wear on exposed armor rims", "notes": "Near-detail only; outer crowd uses instanced proxy geometry."}, "evidenceRefs": ["front-three-quarter", "side"], "details": [], "fidelityTier": "form-refinement", "colorMaterialRecipe": {"dominantAlbedo": "rgba(82, 229, 231, 1.0)", "secondaryAlbedo": "rgba(184, 255, 255, 1.0)", "materialClass": "glass", "materialClassConfidence": 0.94, "colorGradient": {"type": "linear", "stops": [{"position": 0.0, "color": "rgba(82, 229, 231, 1.0)"}, {"position": 1.0, "color": "rgba(184, 255, 255, 1.0)"}]}, "evidenceRefs": ["front-three-quarter"], "notes": "ImageGen v3 turnaround palette; verify under neutral and grazing light before final art lock."}};
  ...
  const mesh_eye_cavity_l_14 = new THREE.Mesh(
    ...
    createSculptMaterial("base", {"id": "base", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#162132", "color": "#162132", "albedo": {"dominant": "#162132", "secondary": ["#383B3D", "#797A7A"], "samplingNotes": "ImageGen v3 palette; not a baked final texture."}, "colorVariation": {"palette": ["#162132", "#383B3D", "#797A7A"], "pattern": "turnaround-derived layered response", "amplitude": 0.18, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "broad plate and cloth value breakup"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.18, "role": "ridges, seams, scales, and panel grooves"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.06, "role": "grazing-light highlight breakup"}], "roughness": {"base": 0.48, "variation": 0.18, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object reference-derived roughness evidence; semantic material mask remains a follow-up"}, "metalness": {"base": 0.84, "variation": 0.08}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.26, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.035, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical full-object extracted cavity evidence; semantic material mask remains a follow-up."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "turnaround-material-evidence", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Generated from the ImageGen turnaround using official img2threejs Forge extraction; semantic material masks remain a follow-up."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe using canonical shared pixel maps. Final material lock requires semantic masks, browser comparison renders, and (for TRELLIS output) a real multi-view mesh review.", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\void-iron-scale-sentinel-v3\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "canonical full-object pixel evidence shared by material recipes; not a semantic material mask", "usable": true, "verdict": "pass", "confidence": 0.769, "estimatedFidelity": 0.769, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 384, "sourceHeight": 1024, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 384, "height": 1024}, "mask": {"backgroundColor": "#121E2F", "backgroundNoise": 8.124, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9514}, "mapStats": {"valueRange": 0.2247, "heightP90Gradient": 0.09184, "roughnessBase": 0.697, "roughnessVariation": 0.172, "normalStrength": 0.264, "blurRadius": 21}, "palette": ["#162132", "#121B2A", "#0D0E10", "#383B3D", "#797A7A"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "low value range weakens height/roughness inference"], "materialId": "base", "sharedEvidenceMaterial": null}, "qualityTier": "hero"}, options, true)
  );
...
export function createVoidIronCultivatorV3LookDevLights(
  mode: 'neutral' | 'grazing' | 'reference' = 'neutral',
): THREE.Group {
  const lights = new THREE.Group();
  lights.name = "Void-Iron Cultivator v3 look-dev lights";
  ...
  lights.userData.lightingFromPhoto = [{"role": "key", "direction": [-0.35, 0.72, 0.58], "color": "#BFD8FF", "intensity": 1.8, "notes": "Cool broad upper-left studio key revealing armor bevels."}, {"role": "fill", "direction": [0.45, 0.2, 0.8], "color": "#2CB7D5", "intensity": 0.65, "notes": "Low cyan fill from the core/eye side; preserve face and chest separation."}, {"role": "rim", "direction": [0.1, 0.55, -0.9], "color": "#6B8CFF", "intensity": 1.25, "notes": "Narrow cool rim on mantle, shoulders, and polearm hook."}, {"role": "ambient", "color": "#0B1220", "intensity": 0.42, "notes": "Dark navy environment with ambient occlusion at plate overlaps and ground contact shadow."}, {"role": "exposure", "value": 1.05, "toneMapping": "ACES Filmic", "notes": "Avoid crushing dark armor into a single silhouette."}];
...
export function createVoidIronCultivatorV3Environment(renderer: THREE.WebGLRenderer): THREE.Texture {
...
export function frameVoidIronCultivatorV3Camera(
...
export function createVoidIronCultivatorV3PresentationComposer(
...
export function configureVoidIronCultivatorV3Renderer(renderer: THREE.WebGLRenderer): void {
...
export function createVoidIronCultivatorV3InspectControls(
  camera: THREE.Camera,
