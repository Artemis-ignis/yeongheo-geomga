...
// Generated from ObjectSculptSpec target: Glacier Warden Elite
// Sculpt build pass: blockout
// This factory is intentionally pass-gated. Finish browser screenshot review before unlocking deeper passes.
export function createGlacierWardenEliteModel(options: ProceduralModelOptions = {}): THREE.Group {
  const root = new THREE.Group();
  root.name = "Glacier Warden Elite";
  root.userData.reconstructionEvidence = {"itemFamily": null, "subtype": null, "componentAdapter": null, "route": null, "exactnessTier": null, "referenceCamera": {"solved": false, "fovDegrees": 40.0, "aspect": 1.0, "orientation": {"yaw": 0.0, "pitch": 0.0, "roll": 0.0}, "positionHint": [0.0, 0.0, 3.0], "note": "Orthographic-like studio reference; solve review camera before final likeness lock."}, "approximationNotes": []};
  ...
  materialMap["base"] = createSculptMaterial(
    "base",
    {"id": "base", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#1B2A3D", "color": "#1B2A3D", "albedo": {"dominant": "#0C1427", "secondary": ["#4D6584", "#2A364A", "#8DAECC"], "samplingNotes": "Reference-derived from foreground pixels; de-lit to reduce baked shadows/highlights.", "map": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_albedo.png", "url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}}, "colorVariation": {"palette": ["#0C1427", "#4D6584", "#2A364A", "#8DAECC", "#060A11"], "pattern": "reference-derived pixel palette", "amplitude": 0.214, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.458, "role": "reference-derived broad albedo and height breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.35, "role": "reference-derived cracks, ridges, pores, grain, or leaf clusters"}, {"id": "micro", "frequency": 72.0, "amplitude": 0.14, "role": "reference-derived micro highlight breakup under grazing light"}], "roughness": {"base": 0.703, "variation": 0.161, "map": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_roughness.png", "url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "localResponse": "reference-derived roughness estimate; cavities and textured zones trend rougher, bright highlights trend smoother"}, "metalness": {"base": 0.74, "variation": 0.12}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.263, "map": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_normal.png", "url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "heightSource": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_height.png", "url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.041, "map": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_height.png", "url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.38, "contactShadowBias": 0.35, "map": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_ao.png", "url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}, "notes": "Reference-derived cavity estimate from local height minima; verify against grazing-light screenshot."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}, {"id": "reference-pbr-pixel-evidence", "type": "material-map-evidence", "evidenceRefs": ["full-object"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Use generated maps as material evidence, then refine after browser screenshot comparison."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"version": "1.0", "sourceImage": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\turnaround\\front.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "single-image pixel evidence with de-lighting estimate; not photogrammetry", "usable": true, "verdict": "pass", "confidence": 0.841, "estimatedFidelity": 0.841, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_albedo.png", "url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_roughness.png", "url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_height.png", "url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_normal.png", "url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"path": "C:\\Users\\50106\\Desktop\\3D게임\\artifacts\\img2threejs\\glacier-warden-v1\\pbr-evidence\\base_ao.png", "url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 444, "sourceHeight": 941, "mapSize": 1024, "cropBBoxPixels": {"x": 0, "y": 0, "width": 444, "height": 941}, "mask": {"backgroundColor": "#0B1226", "backgroundNoise": 1.414, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9997}, "mapStats": {"valueRange": 0.5097, "heightP90Gradient": 0.09111, "roughnessBase": 0.703, "roughnessVariation": 0.161, "normalStrength": 0.263, "blurRadius": 21}, "palette": ["#0C1427", "#4D6584", "#2A364A", "#8DAECC", "#060A11"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak"]}, "qualityTier": "hero"},
    options
  );
  materialMap["hidden"] = createSculptMaterial(
    "hidden",
    {"id": "hidden", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#111A2A", "color": "#111A2A", "albedo": {"dominant": "#111A2A", "secondary": ["#34455E"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#111A2A", "#34455E"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.92, "variation": 0.05, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.02, "variation": 0.02}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.16, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "opacity": {"base": 0.0}, "referencePbr": {"materialId": "hidden", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "utility"},
    options
  );
  materialMap["skin"] = createSculptMaterial(
    "skin",
    {"id": "skin", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#0D1421", "color": "#0D1421", "albedo": {"dominant": "#0D1421", "secondary": ["#384B64"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#0D1421", "#384B64"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.72, "variation": 0.12, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.04, "variation": 0.02}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.16, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"materialId": "skin", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "hero"},
    options
  );
  materialMap["hair"] = createSculptMaterial(
    "hair",
    {"id": "hair", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#B9EDFF", "color": "#B9EDFF", "albedo": {"dominant": "#B9EDFF", "secondary": ["#4D83B8", "#E9FBFF"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#B9EDFF", "#4D83B8", "#E9FBFF"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.26, "variation": 0.18, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.2, "variation": 0.08}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.25, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"materialId": "hair", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "hero"},
    options
  );
  materialMap["shirt"] = createSculptMaterial(
    "shirt",
    {"id": "shirt", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#24344D", "color": "#24344D", "albedo": {"dominant": "#24344D", "secondary": ["#6D87A3", "#101A2B"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#24344D", "#6D87A3", "#101A2B"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.76, "variation": 0.12, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.04, "variation": 0.02}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.16, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"materialId": "shirt", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "hero"},
    options
  );
  materialMap["pants"] = createSculptMaterial(
    "pants",
    {"id": "pants", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#24344D", "color": "#24344D", "albedo": {"dominant": "#24344D", "secondary": ["#6D87A3", "#101A2B"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#24344D", "#6D87A3", "#101A2B"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.78, "variation": 0.1, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.03, "variation": 0.02}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.16, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"materialId": "pants", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "hero"},
    options
  );
  materialMap["shoes"] = createSculptMaterial(
    "shoes",
    {"id": "shoes", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#162236", "color": "#162236", "albedo": {"dominant": "#162236", "secondary": ["#5B718B", "#0E1522"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#162236", "#5B718B", "#0E1522"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.48, "variation": 0.16, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.48, "variation": 0.12}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.16, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"materialId": "shoes", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "hero"},
    options
  );
  materialMap["eye"] = createSculptMaterial(
    "eye",
    {"id": "eye", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#47E8FF", "color": "#47E8FF", "albedo": {"dominant": "#47E8FF", "secondary": ["#D7FBFF", "#0B718A"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#47E8FF", "#D7FBFF", "#0B718A"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.16, "variation": 0.08, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.04, "variation": 0.02}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.25, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"materialId": "eye", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "hero"},
    options
  );
  materialMap["lips"] = createSculptMaterial(
    "lips",
    {"id": "lips", "name": "Base material", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#0D1421", "color": "#0D1421", "albedo": {"dominant": "#0D1421", "secondary": ["#384B64"], "samplingNotes": "ImageGen Glacier Warden palette; not a baked final texture."}, "colorVariation": {"palette": ["#0D1421", "#384B64"], "pattern": "ice-edge and blue-steel value breakup", "amplitude": 0.2, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensityIntent": "Preserve stable world/object-scale detail; do not stretch micro detail with component scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.32, "role": "large armor and cloak value breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.2, "role": "facets, seams, frost plates, and weapon grooves"}, {"id": "micro", "frequency": 60.0, "amplitude": 0.06, "role": "grazing-light ice highlight breakup"}], "roughness": {"base": 0.72, "variation": 0.1, "map": "pbr-evidence/base_roughness.png", "localResponse": "canonical full-object Forge evidence; semantic material mask explicitly pending"}, "metalness": {"base": 0.02, "variation": 0.02}, "normal": {"pattern": "canonical reference-derived height-gradient normal", "strength": 0.16, "map": "pbr-evidence/base_normal.png", "heightSource": "pbr-evidence/base_height.png", "space": "tangent"}, "bump": {"pattern": "canonical reference-derived height field", "amplitude": 0.032, "map": "pbr-evidence/base_height.png"}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.42, "contactShadowBias": 0.3, "map": "pbr-evidence/base_ao.png", "notes": "Canonical Forge cavity evidence shared by material recipes."}, "wear": {"edgeWear": 0.0, "scratches": [], "chips": []}, "dirt": {"amount": 0.0, "cavityBias": 0.0, "color": "#2F2A22"}, "localOverrides": [{"id": "frost-edge-and-cavity", "type": "material-map-evidence", "evidenceRefs": ["front-three-quarter", "front"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Official img2threejs Forge evidence with authored material-local frost response; semantic masks remain explicitly pending."}], "shaderNotes": ["Prefer MeshPhysicalMaterial when clearcoat, sheen, transmission, or thin-surface response is observed; otherwise use MeshStandardMaterial-compatible PBR channels.", "Generate albedo, roughness, height/normal, and AO independently; never alias albedo into roughness.", "Use normal/bump/displacement only when they map to observed surface relief.", "Use displacement geometry when the observed relief changes the close-up silhouette; texture-only relief is insufficient there."], "notes": "ImageGen/img2threejs evidence-backed recipe with canonical shared maps. Final material lock requires semantic masks, neutral/grazing browser renders, and real mesh review.", "referencePbr": {"materialId": "lips", "usable": true, "verdict": "pass-shared-reference-evidence", "confidence": 0.72, "estimatedFidelity": 0.72, "targetThreshold": 0.7, "sourceImage": "artifacts/img2threejs/glacier-warden-v1/turnaround/front.png", "method": "canonical full-object Forge pixel evidence shared by material recipes; not a semantic material mask", "sharedEvidenceMaterial": "base", "maps": {"albedo": {"url": "pbr-evidence/base_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"url": "pbr-evidence/base_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"url": "pbr-evidence/base_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"url": "pbr-evidence/base_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"url": "pbr-evidence/base_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "warnings": ["semantic material masks remain pending; material color/roughness response is authored per family"]}, "sharedReferenceEvidence": {"sourceMaterial": "base", "semanticMaskStatus": "pending", "reason": "A single turnaround crop cannot prove per-material masks; do not duplicate the same map set."}, "qualityTier": "utility"},
    options
  );
  ...
  node_pelvis_1.userData.sculptComponent = {"id": "pelvis", "name": "Pelvis", "level": "macro", "role": "body", "importance": 0.9, "confidence": 0.8, "primitive": "ellipsoid", "topologyClass": "assembled-solid", "topologyRationale": "Pelvis is a discrete primitive body part assembled onto the humanoid rig, not a continuous sculpt or shell.", "geometryDescriptor": {"topologyIntent": "stylized character part", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "smooth vertex normals"}, "parent": "root", "attachment": null, "dimensions": {"width": 0.4522, "height": 0.2856, "depth": 0.35700000000000004, "units": "relative", "confidence": 0.8}, "transform": {"position": [0.0, -0.18200000000000002, 0.0], "rotation": [0, 0, 0], "scale": [0.4522, 0.2856, 0.35700000000000004]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false, "notes": "box proxy"}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "pelvis", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "pants"}}, "material": "base", "materialLayers": ["base"], "deformations": [], "joints": [], "seams": [], "localFeatures": [{"id": "pelvis-surface-breakup", "kind": "faceted-relief", "description": "Ice Warden panel breakup derived from the ImageGen turnaround.", "evidenceRefs": ["front-three-quarter", "front"], "realization": "geometry-plus-material-response"}, {"id": "waist-frost-buckle", "kind": "fastener", "description": "Angular frost buckle anchors the layered waist plates.", "evidenceRefs": ["front", "side"], "realization": "geometry-plus-material-response"}, {"id": "split-ice-cloak", "kind": "contour", "description": "Long split cloak panels create separate back and leg negative spaces.", "evidenceRefs": ["back", "side"], "realization": "geometry-plus-material-response"}], "surfaceDetail": {"macroRoughness": 0.32, "microRoughness": 0.12, "bumpAmplitude": 0.04, "normalPattern": "canonical Forge evidence plus authored frost fractures", "displacementPattern": "micro bevel only; no runtime displacement", "occlusionPattern": "contact darkening beneath overlapping ice plates and cloak sockets", "edgeWearPattern": "pale chipped edges on exposed crystal rims", "notes": "Near-detail only; outer crowd remains instanced proxy geometry."}, "evidenceRefs": ["front-three-quarter", "front"], "details": [], "fidelityTier": "structural-pass", "colorMaterialRecipe": {"dominantAlbedo": "rgba(27, 42, 61, 1.0)", "secondaryAlbedo": "rgba(124, 155, 184, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.9, "colorGradient": {"type": "linear", "stops": [{"position": 0.0, "color": "rgba(27, 42, 61, 1.0)"}, {"position": 1.0, "color": "rgba(124, 155, 184, 1.0)"}]}, "evidenceRefs": ["front-three-quarter"], "notes": "ImageGen Glacier Warden turnaround palette; verify under neutral and grazing light."}};
...
export function createGlacierWardenEliteLookDevLights(
  mode: 'neutral' | 'grazing' | 'reference' = 'neutral',
): THREE.Group {
  const lights = new THREE.Group();
  lights.name = "Glacier Warden Elite look-dev lights";
  ...
  lights.userData.lightingFromPhoto = [{"role": "key", "direction": [-0.35, 0.72, 0.58], "color": "#D7F1FF", "intensity": 1.9, "notes": "Cool broad key revealing ice bevels and dark mask planes."}, {"role": "fill", "direction": [0.45, 0.2, 0.8], "color": "#37C7E8", "intensity": 0.62, "notes": "Cyan fill from eyes, shoulder crystals, and glaive core."}, {"role": "rim", "direction": [0.1, 0.55, -0.9], "color": "#A6D8FF", "intensity": 1.35, "notes": "Silver rim on crown, cloak edges, boots, and weapon hook."}, {"role": "ambient", "color": "#0A1220", "intensity": 0.4, "notes": "Deep navy environment with contact shadow and ambient occlusion under plate overlaps, boots, cloak, and weapon socket."}, {"role": "exposure", "value": 1.05, "toneMapping": "ACES Filmic", "notes": "Keep dark steel readable without flattening the frost highlights."}];
...
export function createGlacierWardenEliteEnvironment(renderer: THREE.WebGLRenderer): THREE.Texture {
...
export function frameGlacierWardenEliteCamera(
...
export function createGlacierWardenElitePresentationComposer(
...
export function configureGlacierWardenEliteRenderer(renderer: THREE.WebGLRenderer): void {
...
export function createGlacierWardenEliteInspectControls(
  camera: THREE.Camera,
